...
const getLaptopAction = () => {
	return (dispatch) => {
		...
		getProductCategoryAPI('Laptop').then((response) => {
			if (response.data.success) {
				dispatch({
...
const getMonitorAction = () => {
	return (dispatch) => {
		...
		getProductCategoryAPI('Monitor').then((response) => {
			if (response.data.success) {
				dispatch({
...
const getCPUAction = () => {
	return (dispatch) => {
		...
		getProductCategoryAPI('CPU').then((response) => {
			if (response.data.success) {
				dispatch({
...
export { getTopRatingAction, getLaptopAction, getMonitorAction, getCPUAction };
